...
def main():
    ...
    deplog("Command: WindowTitle: Välkommen till Bonnier News!")
    deplog("Command: NotificationOn:")
    deplog("Command: Quit: Grundinstallationen av din dator är strax klar.")
    deplog("Command: WindowStyle: ActivateOnStep")
